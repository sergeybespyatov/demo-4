(() => {
  "use strict";
  !(function () {
    const e = document.querySelectorAll(".filter-button");
    document.querySelectorAll(".slide-filter"),
      e.forEach((e) => {
        e.addEventListener("click", () => {
          const t = document.querySelectorAll(".slide-filter");
          var s;
          (s = e.dataset.filter),
            t.forEach((e) => {
  ...
  if (e.length > 0) {
    for (let we = 0; we < e.length; we++) {
      e[we].addEventListener("click", be);
    }
    function be(t) {
    ...
    ge(),
      document.querySelector(".swiper") &&
        (new le(".slider-main", {
          ...
          speed: 800,
          pagination: {
            el: ".slide-counter .slide-counter__body",
            clickable: !0,
            type: "custom",
            renderCustom: function (e, t, s) {
              let i = "",
                ...
                r = ["Dolorem apset", "Dolorem apset", "Dolorem apset"];
              for (let e = 1; e <= s; e++)
                i +=
                  e == t
                    ? `<div class='slide-counter__item swiper-pagination-bullet-active'>\n                            <div class='slide-counter__count'>${
                        n[e - 1]
                      }</div>\n\t\t\t\t\t\t\t\t\t <div class="slide-counter__text">\n\t\t\t\t\t\t\t\t\t\t\t<span>${
                        a[e - 1]
                      }</span>\n\t\t\t\t\t\t\t\t\t\t\t<span>${
                        r[e - 1]
                      }</span>\n\t\t\t\t\t\t\t\t\t\t</div>\n                          </div>`
                    : `<div class='slide-counter__item swiper-pagination-bullet'>\n                            <div class='slide-counter__count'>${
                        n[e - 1]
                      }</div>\n\t\t\t\t\t\t\t\t\t <div class="slide-counter__text">\n\t\t\t\t\t\t\t\t\t\t\t<span>${
                        a[e - 1]
                      }</span>\n\t\t\t\t\t\t\t\t\t\t\t<span>${
        ...
        new le(".latest-projects__slider", {
          modules: [ue],
          observer: !0,
          observeParents: !0,
          autoHeight: !0,
          ...
          pagination: {
            el: ".latest-projects .latest-projects__pagination",
            clickable: !0,
          },
          breakpoints: {
        ...
        new le(".comment__slider", {
          ...
          speed: 800,
          centerInsufficientSlides: !1,
          pagination: { el: ".comment .comment__pagination", clickable: !0 },
          breakpoints: {
  ...
  setTimeout(() => {
    ...
    (window.onload = function () {
      const e = document.documentElement,
        t = document.querySelectorAll(".menu__list > li");
      t.forEach((e) => {
        e.childNodes[2]
          ? e.classList.add("_nested-list")
          : e.classList.remove("_nested-list");
      }),
        e.classList.contains("touch") &&
          t.forEach((e) => {
            const t = e.childNodes[2];
            t && t.classList.add("sub-menu"),
              e.addEventListener("click", () => {
                t.classList.contains("sub-menu") &&
                  (t.classList.toggle("active"), e.classList.toggle("active"));
              });
          });
      const s = document.querySelectorAll(".language-selection__item");
      if (s.length > 0) {
